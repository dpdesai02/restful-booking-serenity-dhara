package com.resstful.booker.serenity.utils;
...
public class PropertyReader {
    ...
    public String getProperty(String propertyName){
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/src/test/java/com/restful/booker/resources/application.properties");
